...
-- TABELA DE USUÁRIOS
-- ============================
INSERT INTO user_table (id, name, email, phone, password, roles)
...
-- ============================
-- TABELA DE PEDIDOS (order_table)
-- ============================
-- Status: 0=AWAITING_PAYMENT, 1=PAID, 2=SHIPPED, 3=DELIVERED, 4=CANCELLED
INSERT INTO order_table (id, moment, status, cliente_id)
VALUES (UUID(), NOW(), 0, (SELECT id FROM user_table WHERE email = 'aline.carvalho@example.com')),
       (UUID(), NOW(), 1, (SELECT id FROM user_table WHERE email = 'ana.santos@example.com')),
       (UUID(), NOW(), 2, (SELECT id FROM user_table WHERE email = 'joao.silva@example.com')),
       (UUID(), NOW(), 3, (SELECT id FROM user_table WHERE email = 'pedro.lima@example.com')),
       (UUID(), NOW(), 4, (SELECT id FROM user_table WHERE email = 'maria.oliveira@example.com')),
       (UUID(), NOW(), 1, (SELECT id FROM user_table WHERE email = 'bruno.ferreira@example.com')),
       (UUID(), NOW(), 0, (SELECT id FROM user_table WHERE email = 'fernanda.costa@example.com')),
       (UUID(), NOW(), 2, (SELECT id FROM user_table WHERE email = 'lucas.rocha@example.com')),
       (UUID(), NOW(), 3, (SELECT id FROM user_table WHERE email = 'juliana.martins@example.com')),
       (UUID(), NOW(), 4, (SELECT id FROM user_table WHERE email = 'rafael.monteiro@example.com'));

-- ============================
-- TABELA DE ITENS DE PEDIDO (order_item_table)
-- ============================
-- Pedido da Aline Carvalho
INSERT INTO order_item_table (order_id, product_id, quantity, price)
VALUES ((SELECT id
         FROM order_table
         WHERE cliente_id = (SELECT id FROM user_table WHERE email = 'aline.carvalho@example.com')),
...
-- Pedido da Ana Santos
INSERT INTO order_item_table (order_id, product_id, quantity, price)
VALUES ((SELECT id
         FROM order_table
         WHERE cliente_id = (SELECT id FROM user_table WHERE email = 'ana.santos@example.com')),
...
-- Pedido do João Silva
INSERT INTO order_item_table (order_id, product_id, quantity, price)
VALUES ((SELECT id
         FROM order_table
         WHERE cliente_id = (SELECT id FROM user_table WHERE email = 'joao.silva@example.com')),
